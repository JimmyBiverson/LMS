            ...
            <div class="flex items-start gap-6">
                ...
                <div class="flex-1">
                    ...
                    <div class="flex items-center gap-3 mt-4">
                        <a href="#" class="px-5 py-2.5 bg-primary text-white text-sm font-semibold rounded-full hover:opacity-90 transition-all duration-300"><i class="ri-mail-line mr-1"></i>Send Email</a>
                        <a href="#" class="px-5 py-2.5 bg-secondary text-heading text-sm font-semibold rounded-full hover:opacity-90 transition-all duration-300"><i class="ri-share-line mr-1"></i>Share</a>
                    </div>
                </div>
            </div>
        </div>
