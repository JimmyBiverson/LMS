...
@section('title', 'Org Notifications')
...
<div class="max-w-3xl space-y-4">
    ...
    <div class="bg-white rounded-xl shadow-sm p-5 flex items-start gap-4 hover:shadow-md transition-all">
        ...
        <div class="flex-1"><p class="font-semibold text-heading">New instructor <span class="text-primary">"Instructor {{ $i }}"</span> joined</p><p class="text-xs text-heading/50 mt-1">{{ $i }} hour{{ $i > 1 ? 's' : '' }} ago</p></div>
