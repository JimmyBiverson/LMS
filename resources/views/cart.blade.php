            ...
            <div class="bg-white rounded-xl shadow-sm overflow-hidden">
                    ...
                    <div class="flex items-center gap-4 p-6">
                        ...
                        <div class="text-right shrink-0">
                            <div class="font-bold text-heading">
                                @if($item['price'] > 0)
                                    {{ \App\Helpers\CurrencyHelper::format((float)$item['price']) }}
                                @else
                ...
                <div class="bg-gray-50 p-6 flex items-center justify-between">
                    <div>
                        ...
                        <span class="text-2xl font-extrabold text-heading ml-2">{{ \App\Helpers\CurrencyHelper::format((float)$total) }}</span>
                    </div>
