...
<div class="space-y-4 max-w-3xl">
    <div class="flex items-center justify-between"><h3 class="font-bold text-heading">All Notices</h3><a href="#" class="px-4 py-2 bg-primary text-white text-sm font-semibold rounded-full hover:opacity-90 transition-all"><i class="ri-add-line mr-1"></i>Add Notice</a></div>
    @for($i=1;$i<=4;$i++)
