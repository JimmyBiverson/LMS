...
<section class="py-12 lg:py-16">
    <div class="max-w-4xl mx-auto px-4">
        <div class="bg-white rounded-xl p-8 shadow-sm prose prose-sm max-w-none text-heading/70">
            ...
            <p>All content, including but not limited to text, images, videos, courses, software, and other materials available on the Website, are owned by or licensed to [Your LMS Website Name] and are protected by intellectual property laws. You may not reproduce, distribute, or create derivative works from any content without prior written consent from the owner.</p>

            <h3 class="text-lg font-bold text-heading mt-6">5. Content Submission</h3>
            <p>If you submit any content (such as course materials, comments, or feedback) through the Website, you grant Edulab a worldwide, royalty-free, and irrevocable license to use, reproduce, modify, and distribute that content in connection with the Website and its Services.</p>
            ...
            <p>To the fullest extent permitted by law, [Your LMS Website Name] and its affiliates will not be liable for any indirect, incidental, special, consequential, or punitive damages, including but not limited to loss of profits, arising out of or related to these Terms, the use of the Website, or the Services.</p>
            ...
            <p>These Terms shall be governed by and construed in accordance with the laws of [Your Jurisdiction], without regard to its conflict of laws principles. Any disputes arising from or related to these Terms shall be resolved in the courts located in [Your Jurisdiction].</p>
