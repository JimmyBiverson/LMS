        ...
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50 transition-colors">
                    ...
                    <td class="py-4 px-6 text-heading/70">{{ $r->score }}/{{ $r->total_marks }}</td>
                    <td class="py-4 px-6"><span class="px-3 py-1 rounded-full text-xs font-bold {{ $r->passed ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700' }}">{{ $r->passed ? 'Passed' : 'Failed' }}</span></td>
