            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="py-4 px-6 flex items-center gap-3">
                        <img src="{{ $student->profile_image_url ?? 'https://ui-avatars.com/api/?name=' . urlencode($student->full_name) . '&background=5F3EED&color=fff&size=32' }}" width="32" height="32" loading="lazy" class="w-8 h-8 rounded-full">
