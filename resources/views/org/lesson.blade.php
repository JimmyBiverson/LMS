...
@section('content')
<div class="mb-6">
    <a href="{{ route('org.dashboard.courses.edit', $course->id) }}" class="text-sm text-primary hover:underline">&larr; Back to Course</a>
</div>
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="py-4 px-6 text-right">
                                <form method="POST" action="{{ route('org.dashboard.courses.lessons.delete', [$course->id, $lesson->id]) }}" class="inline" onsubmit="return confirm('Delete this lesson?')">
                                    @csrf
