...
<div class="min-w-full min-h-screen flex items-center">
    ...
    <div class="grow min-h-screen h-full w-full lg:w-1/2 pt-32 pb-12 px-3 lg:p-3 flex-center flex-col">
        ...
        <div class="dashkit-tab flex-center gap-2 flex-wrap mt-10" id="registerTab">
            ...
            <button type="button" aria-label="User registration tab for Instructor"
                ...
                data-tab="instructor">Instructor</button>
            <button type="button" aria-label="User registration tab for Organization"
                class="dashkit-tab-btn btn b-light btn-primary-light btn-lg h-11 !rounded-full text-[14px] sm:text-[16px] md:text-[18px] [&.active]:bg-primary [&.active]:text-white"
                data-tab="organization">Organization</button>
        </div>

        <div class="dashkit-tab-content mt-10 w-full max-w-screen-sm *:hidden" id="registerFormContent">
            {{-- Student Form --}}
            <div class="dashkit-tab-pane !block" data-tab="student">
                <form method="POST" action="{{ route('register') }}" class="register-form w-full form">
                    @csrf
                    ...
                    <div class="grid grid-cols-2 gap-x-3 gap-y-5">
                        <div class="col-span-full lg:col-auto">
                            <div class="relative">
                                ...
                                <label for="std_first_name" class="form-label floating-form-label">First Name <span class="text-red-500">*</span></label>
                            </div>
                            @error('first_name') <p class="text-red-500 text-xs mt-1 px-4">{{ $message }}</p> @enderror
                        </div>
                        <div class="col-span-full lg:col-auto">
                            <div class="relative">
                                ...
                                <label for="std_last_name" class="form-label floating-form-label">Last Name <span class="text-red-500">*</span></label>
                            </div>
                            @error('last_name') <p class="text-red-500 text-xs mt-1 px-4">{{ $message }}</p> @enderror
                        </div>
                        <div class="col-span-full lg:col-auto">
                            <div class="relative">
                                ...
                                <label for="std_email" class="form-label floating-form-label">Email <span class="text-red-500">*</span></label>
                            </div>
                        ...
                        <div class="col-span-full lg:col-auto">
                            <div class="relative">
                                ...
                                <label for="std_phone" class="form-label floating-form-label">Phone <span class="text-red-500">*</span></label>
                            </div>
                            @error('phone') <p class="text-red-500 text-xs mt-1 px-4">{{ $message }}</p> @enderror
                        </div>
                        <div class="col-span-full lg:col-auto">
                            <div class="relative">
                                ...
                                <label for="std_password" class="form-label floating-form-label">Password <span class="text-red-500">*</span></label>
                        ...
                        <div class="col-span-full lg:col-auto">
                            <div class="relative">
                                ...
                                <label for="std_password_confirmation" class="form-label floating-form-label">Confirm Password <span class="text-red-500">*</span></label>
                                <label class="size-8 rounded-full cursor-pointer flex-center hover:bg-gray-200 focus:bg-gray-200 absolute top-1/2 -translate-y-1/2 right-2 rtl:right-auto rtl:left-2">
                                    <input type="checkbox" class="inputTypeToggle peer/it" hidden>
                                    <i class="ri-eye-off-line text-gray-500 peer-checked/it:before:content-['\ecb5']"></i>
                                </label>
            ...
            {{-- Instructor Form --}}
            <div class="dashkit-tab-pane" data-tab="instructor">
                <form method="POST" action="{{ route('register') }}" class="register-form w-full form">
                    @csrf
                    ...
                    <div class="grid grid-cols-2 gap-x-3 gap-y-5">
                        <div class="col-span-full lg:col-auto">
                            <div class="relative">
                                <input type="text" name="first_name" id="ins_first_name" value="{{ old('first_name') }}"
                                    class="form-input rounded-full peer @error('first_name') border-red-500 @enderror" placeholder=" ">
                                <label for="ins_first_name" class="form-label floating-form-label">First Name <span class="text-red-500">*</span></label>
                            </div>
                            @error('first_name') <p class="text-red-500 text-xs mt-1 px-4">{{ $message }}</p> @enderror
                        </div>
                        <div class="col-span-full lg:col-auto">
                            <div class="relative">
                                <input type="text" name="last_name" id="ins_last_name" value="{{ old('last_name') }}"
                                    class="form-input rounded-full peer @error('last_name') border-red-500 @enderror" placeholder=" ">
                                <label for="ins_last_name" class="form-label floating-form-label">Last Name <span class="text-red-500">*</span></label>
                            </div>
                            @error('last_name') <p class="text-red-500 text-xs mt-1 px-4">{{ $message }}</p> @enderror
                        </div>
                        <div class="col-span-full lg:col-auto">
                            <div class="relative">
                                <input type="email" name="email" id="ins_email" value="{{ old('email') }}"
                                    class="form-input rounded-full peer @error('email') border-red-500 @enderror" placeholder=" " required>
                                <label for="ins_email" class="form-label floating-form-label">Email <span class="text-red-500">*</span></label>
                            </div>
                            @error('email') <p class="text-red-500 text-xs mt-1 px-4">{{ $message }}</p> @enderror
                        </div>
                        <div class="col-span-full lg:col-auto">
                            <div class="relative">
                                <input type="text" name="phone" id="ins_phone" value="{{ old('phone') }}"
                                    class="form-input rounded-full peer @error('phone') border-red-500 @enderror" placeholder=" " required>
                                <label for="ins_phone" class="form-label floating-form-label">Phone <span class="text-red-500">*</span></label>
                            </div>
                            @error('phone') <p class="text-red-500 text-xs mt-1 px-4">{{ $message }}</p> @enderror
                        </div>
                        <div class="col-span-full lg:col-auto">
                            <div class="relative">
                                <input type="password" name="password" id="ins_password"
                                    class="form-input rounded-full peer @error('password') border-red-500 @enderror" placeholder=" " required>
                                <label for="ins_password" class="form-label floating-form-label">Password <span class="text-red-500">*</span></label>
                                <label class="size-8 rounded-full cursor-pointer flex-center hover:bg-gray-200 focus:bg-gray-200 absolute top-1/2 -translate-y-1/2 right-2 rtl:right-auto rtl:left-2">
                                    <input type="checkbox" class="inputTypeToggle peer/it" hidden>
                                    <i class="ri-eye-off-line text-gray-500 peer-checked/it:before:content-['\ecb5']"></i>
                                </label>
                        ...
                        <div class="col-span-full lg:col-auto">
                            <div class="relative">
                                <input type="password" name="password_confirmation" id="ins_password_confirmation"
                                    class="form-input rounded-full peer" placeholder=" " required>
                                <label for="ins_password_confirmation" class="form-label floating-form-label">Confirm Password <span class="text-red-500">*</span></label>
                                <label class="size-8 rounded-full cursor-pointer flex-center hover:bg-gray-200 focus:bg-gray-200 absolute top-1/2 -translate-y-1/2 right-2 rtl:right-auto rtl:left-2">
                                    <input type="checkbox" class="inputTypeToggle peer/it" hidden>
                                    <i class="ri-eye-off-line text-gray-500 peer-checked/it:before:content-['\ecb5']"></i>
                                </label>
                        ...
                        <div class="col-span-full">
                            <div class="relative">
                                ...
                                <label for="ins_designation" class="form-label floating-form-label">Designation <span class="text-red-500">*</span></label>
                            </div>
                            @error('designation') <p class="text-red-500 text-xs mt-1 px-4">{{ $message }}</p> @enderror
                        </div>
                        <div class="col-span-full">
                            <button type="submit" class="btn b-solid btn-secondary-solid !text-heading dark:text-white btn-xl !rounded-full font-bold w-full h-12" aria-label="Sign up">
                                Sign up
            ...
            {{-- Organization Form --}}
            <div class="dashkit-tab-pane" data-tab="organization">
                <form method="POST" action="{{ route('register') }}" class="register-form w-full form">
                    @csrf
                    ...
                    <div class="grid grid-cols-2 gap-x-3 gap-y-5">
                        <div class="col-span-full">
                            <div class="relative">
                                ...
                                <label for="org_name" class="form-label floating-form-label">Full Name <span class="text-red-500">*</span></label>
                            </div>
                            @error('name') <p class="text-red-500 text-xs mt-1 px-4">{{ $message }}</p> @enderror
                        </div>
                        <div class="col-span-full lg:col-auto">
                            <div class="relative">
                                <input type="email" name="email" id="org_email" value="{{ old('email') }}"
                                    class="form-input rounded-full peer @error('email') border-red-500 @enderror" placeholder=" " required>
                                <label for="org_email" class="form-label floating-form-label">Email <span class="text-red-500">*</span></label>
                            </div>
                            @error('email') <p class="text-red-500 text-xs mt-1 px-4">{{ $message }}</p> @enderror
                        </div>
                        <div class="col-span-full lg:col-auto">
                            <div class="relative">
                                <input type="text" name="phone" id="org_phone" value="{{ old('phone') }}"
                                    class="form-input rounded-full peer @error('phone') border-red-500 @enderror" placeholder=" " required>
                                <label for="org_phone" class="form-label floating-form-label">Phone <span class="text-red-500">*</span></label>
                            </div>
                            @error('phone') <p class="text-red-500 text-xs mt-1 px-4">{{ $message }}</p> @enderror
                        </div>
                        <div class="col-span-full lg:col-auto">
                            <div class="relative">
                                <input type="password" name="password" id="org_password"
                                    class="form-input rounded-full peer @error('password') border-red-500 @enderror" placeholder=" " required>
                                <label for="org_password" class="form-label floating-form-label">Password <span class="text-red-500">*</span></label>
                                <label class="size-8 rounded-full cursor-pointer flex-center hover:bg-gray-200 focus:bg-gray-200 absolute top-1/2 -translate-y-1/2 right-2 rtl:right-auto rtl:left-2">
                                    <input type="checkbox" class="inputTypeToggle peer/it" hidden>
                                    <i class="ri-eye-off-line text-gray-500 peer-checked/it:before:content-['\ecb5']"></i>
                                </label>
                        ...
                        <div class="col-span-full lg:col-auto">
                            <div class="relative">
                                <input type="password" name="password_confirmation" id="org_password_confirmation"
                                    class="form-input rounded-full peer" placeholder=" " required>
                                <label for="org_password_confirmation" class="form-label floating-form-label">Confirm Password <span class="text-red-500">*</span></label>
                                <label class="size-8 rounded-full cursor-pointer flex-center hover:bg-gray-200 focus:bg-gray-200 absolute top-1/2 -translate-y-1/2 right-2 rtl:right-auto rtl:left-2">
                                    <input type="checkbox" class="inputTypeToggle peer/it" hidden>
                                    <i class="ri-eye-off-line text-gray-500 peer-checked/it:before:content-['\ecb5']"></i>
                                </label>
...
document.addEventListener('DOMContentLoaded', function() {
    const tabs = document.querySelectorAll('#registerTab .dashkit-tab-btn');
