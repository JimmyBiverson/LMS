...
<div class="space-y-6">
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div class="bg-white rounded-xl shadow-sm p-5"><p class="text-xs text-heading/50 font-semibold uppercase tracking-wider">Total Revenue</p><p class="text-2xl font-bold text-heading mt-1">{{ \App\Helpers\CurrencyHelper::format($totalRevenue) }}</p></div>
        ...
        <div class="bg-white rounded-xl shadow-sm p-5"><p class="text-xs text-heading/50 font-semibold uppercase tracking-wider">Pending</p><p class="text-2xl font-bold text-heading mt-1">{{ \App\Helpers\CurrencyHelper::format($pendingAmount) }}</p></div>
    </div>
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="py-4 px-6 font-semibold text-heading">{{ \App\Helpers\CurrencyHelper::format((float)$t->amount_paid) }}</td>
