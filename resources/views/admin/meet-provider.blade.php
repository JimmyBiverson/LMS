                ...
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="py-4 px-6 text-heading/70 max-w-xs truncate">{{ $p->description ?? 'â€”' }}</td>
                            <td class="py-4 px-6">
                            ...
                            <td class="py-4 px-6">
                                <div class="flex items-center gap-2">
                                    <button x-data="{provider:@js($p)}" @click="editProvider(provider.id, provider.name, provider.description, provider.status)" class="px-3 py-1.5 text-xs font-semibold bg-primary-50 text-primary rounded-lg hover:bg-primary hover:text-white transition-all duration-300">Edit</button>
