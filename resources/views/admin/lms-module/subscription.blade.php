                ...
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="py-4 px-6 text-heading/70">{{ \App\Helpers\CurrencyHelper::format($plan->price) }}</td>
                            ...
                            <td class="py-4 px-6">
                                <div class="flex items-center gap-2">
                                    <button x-data="{plan: @js($plan)}" @click="editPlan(plan.id, plan.name, plan.description, plan.price, plan.duration, plan.duration_months, plan.status, plan.features)" class="px-3 py-1.5 text-xs font-semibold bg-primary-50 text-primary rounded-lg hover:bg-primary hover:text-white transition-all duration-300">Edit</button>
