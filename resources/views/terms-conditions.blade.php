...
<section class="py-12 lg:py-16">
    <div class="max-w-4xl mx-auto px-4">
        <div class="bg-white rounded-xl p-8 shadow-sm prose prose-sm max-w-none text-heading/70">
            ...
            <p>All content, including but not limited to text, images, videos, courses, software and other materials available on the Website, is owned or licensed by {{ $school->school_name ?? config('app.name', 'EduLab') }} and is protected by intellectual property laws. You may not reproduce, distribute or create derivative works from any content without the prior written consent of the owner.</p>

            <h3 class="text-lg font-bold text-heading mt-6">5. Content Submission</h3>
            <p>If you submit any content (such as text content, comments or feedback) via the Website, you grant {{ $school->school_name ?? 'Edulab' }} a worldwide, royalty-free, and irrevocable license to use, reproduce, modify and distribute that content in connection with the Website and its services.</p>
            ...
            <p>To the fullest extent permitted by law, {{ config('app.name', 'EduLab') }} and its affiliates shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including but not limited to lost profits, arising out of or related to these Terms, use of the Website, or the Services.</p>
            ...
            <p>These Terms shall be governed by and construed in accordance with the laws of Uganda, without regard to its conflict of law principles. Any dispute arising out of or relating to these Terms shall be resolved in the courts located in Uganda.</p>
