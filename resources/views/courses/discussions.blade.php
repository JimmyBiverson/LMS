...
<section class="py-12 lg:py-16">
    <div class="max-w-4xl mx-auto px-4">
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 mb-8">
            ...
            @endif
            <form method="POST" action="/courses/{{ $course->slug }}/discussions">
                @csrf
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div class="flex-1 min-w-0">
                        <div class="flex items-center gap-2 mb-1">
                            ...
                            <form method="POST" action="/courses/{{ $course->slug }}/discussions/{{ $discussion->id }}/delete" class="ml-auto">@csrf<button type="submit" class="text-xs text-red-400 hover:text-red-600"><i class="ri-delete-bin-line"></i></button></form>
                            @endcan
                        </div>
                        ...
                        @auth
                        <form method="POST" action="/courses/{{ $course->slug }}/discussions/{{ $discussion->id }}/reply" class="mt-3 flex gap-2">
                            @csrf
