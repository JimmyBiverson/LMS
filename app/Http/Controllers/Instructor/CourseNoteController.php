...
class CourseNoteController extends Controller
{
    ...
    public function edit(CourseNote $courseNote): View
    {
    ...
    public function update(Request $request, CourseNote $courseNote): RedirectResponse
    {
        $this->authorize('update', $courseNote);
    ...
    public function destroy(CourseNote $courseNote): RedirectResponse
    {
