...
<div class="bg-white rounded-xl shadow-sm max-w-2xl">
    ...
    <div class="p-6">
        <form method="POST" action="/instructor/assignments/{{ $assignment->id }}">
            @csrf
            <div class="space-y-4">
                ...
                <div><label class="block text-sm font-semibold text-heading mb-1">Instructions</label><textarea name="instructions" rows="3" class="w-full px-4 py-2.5 border border-gray-200 rounded-lg text-sm">{{ $assignment->instructions }}</textarea></div>
