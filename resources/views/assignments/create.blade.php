    ...
    <div class="p-6">
        <form method="POST" action="/instructor/courses/{{ $course->id }}/assignments" enctype="multipart/form-data">
            ...
            <div class="space-y-4">
                ...
                <div><label class="block text-sm font-semibold text-heading mb-1">Schedule Availability (optional)</label>
                    <input type="datetime-local" name="available_from" value="{{ old('available_from') }}" class="w-full px-4 py-2.5 border border-gray-200 rounded-lg text-sm">
